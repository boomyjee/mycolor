...
async function create3DLutTexture(url) {
    try {
...
function exportLUTAsCube(lutData, size = 64) {
...
// Функция для обновления шейдера при изменении цветовых пространств
